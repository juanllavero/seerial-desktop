...
function DesktopSettings() {
	...
	const settingsOpen = useSelector(
		(state: RootState) => state.contextMenu.settingsMenu
	);
							...
							{menuSection === WindowSections.General ? (
								<>
									...
									<div className="dialog-input-box">
										<div className="flex align-items-center">
											<Checkbox
												onChange={(e) => {
													if (e.checked) setPlayMusic(true);
													else setPlayMusic(false);
												}}
												checked={playMusic}
											></Checkbox>
									...
									<div className="dialog-input-box">
										<div className="flex align-items-center">
											<Checkbox
												onChange={(e) => {
													if (e.checked) setAutoScan(true);
													else setAutoScan(false);
												}}
												checked={autoScan}
											></Checkbox>
											<label className="check-text">
									...
									<div className="dialog-input-box">
										<div className="flex align-items-center">
											<Checkbox
												onChange={(e) => {
													if (e.checked) setHighQuality(true);
													else setHighQuality(false);
												}}
												checked={highQuality}
											></Checkbox>
											<label className="check-text">
												{t("highSettingsPlayer")}
											</label>
										</div>
									</div>
									<div className="dialog-input-box">
										<div className="flex align-items-center">
											<Checkbox
												onChange={(e) => {
													if (e.checked) setInterpolation(true);
													else setInterpolation(false);
												}}
												checked={interpolation}
											></Checkbox>
											<label className="check-text">
												{t("interpolationCheck")}
											</label>
										</div>
										<span className="info-text">
											{t("interpolationMeaning")}
										</span>
									</div>
								</>
							) : menuSection === WindowSections.Details ? (
								<>
									...
									<div className="dialog-input-box">
										<div className="flex align-items-center">
											<Checkbox
												onChange={(e) => {
													if (e.checked) setShowClock(true);
													else setShowClock(false);
												}}
												checked={showClock}
											></Checkbox>
											<label className="check-text">
								...
								<>
									<div className="dialog-input-box">
										...
										<select
											className="select-input"
											value={preferAudioLang}
											onChange={handlePreferAudioChange}
										>
											{languages.map((lang) => (
									...
									<div className="dialog-input-box">
										...
										<select
											className="select-input"
											value={preferSubsLang}
											onChange={handlePreferSubsChange}
										>
											{languages.map((lang) => (
												<option key={lang.code} value={lang.code}>
													{getLanguageName(lang.code) || lang.name}
